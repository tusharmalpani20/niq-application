import { apiErrorSchema, correctPatientMrnSchema, patientSchema, updatePatientSchema, type CorrectPatientMrn, type Patient, type UpdatePatient } from "@niq/application-contracts";
