...
const paths: Record<string, ReactNode> = {
  ...
  check: <path d="m5 12 4 4L19 6"/>, arrow: <path d="m5 12 14 0M13 6l6 6-6 6"/>,
...
export function Icon({ name, size = 20 }: IconProps) { return <svg aria-hidden="true" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">{paths[name]}</svg>; }
