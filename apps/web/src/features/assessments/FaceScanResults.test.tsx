...
test("extended scan metrics survive application validation and render missing values honestly", () => {
  ...
  for (const text of ["HbA1c","&lt;5.7","SDNN","47.5","39.98","Mental wellbeing score","available", "NIQ scan score", "Date of birth at scan", "1990-01-01", "Gender at scan", "Male"]) expect(html).toContain(text);
