...
export function ClinicalReviewQueue({ user }: { user: AuthenticatedUser }) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      if (state !== "all") params.set(state === "mine" ? "mine" : "state", state === "mine" ? "true" : state);
