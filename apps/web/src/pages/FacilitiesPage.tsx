...
export function FacilitiesPage() {
  ...
  const columns: Array<DataTableColumn<Facility>> = [
    { accessorKey: "name", header: "Facility", cell: ({ row }) => <Link className="text-foreground hover:underline font-normal" to={facilityUrl(row.original)}>{row.original.name}</Link> },
