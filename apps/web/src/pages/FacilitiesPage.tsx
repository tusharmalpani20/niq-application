...
export function FacilitiesPage() {
  ...
  const columns: Array<DataTableColumn<Facility>> = [
    { accessorKey: "name", header: "Facility", cell: ({ row }) => <Link className="font-normal text-primary hover:underline focus-visible:underline" to={facilityUrl(row.original)}>{row.original.name}</Link> },
  ...
  return <>
    ...
    <div className="patient-list-header">
      <div className="patient-list-heading"><span className="patient-list-label">Facilities</span><span>{filtered.length}</span></div>
