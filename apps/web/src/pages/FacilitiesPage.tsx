...
export function FacilitiesPage() {
  ...
  const columns: Array<DataTableColumn<Facility>> = [
    { accessorKey: "name", header: "Facility", cell: ({ row }) => <Link className="text-foreground hover:text-primary hover:underline" to={`/facilities/${row.original.id}`}>{row.original.name}</Link> },
