...
const assessment = { id: facilityId, reference: "ASM-000001", serialNumber: 1, organizationId: facilityId, patient: { id: facilityId, reference: "PAT-2", displayName: "Example Patient" }, facility: { id: facilityId, name: "Hyderabad" }, status: "DRAFT", myAction: null, isPriority: false, createdAt: "2026-09-23T00:00:00Z", completedAt: null };
const team = [
