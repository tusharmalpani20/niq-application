...
export function PatientsPage() {
  ...
  return <><PageHeader eyebrow="Clinical records" title="Patients" description="Find patients across your organization's facilities." action={<Link className="btn btn-primary" to="/patients/new"><Icon name="plus" size={18}/>Register patient</Link>}/>
