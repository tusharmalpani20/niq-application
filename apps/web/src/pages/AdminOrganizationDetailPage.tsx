...
export function AdminOrganizationDetailPage() {
  ...
  return <>
    ...
    <div className="admin-detail-grid">
      ...
      <ScoringConnectionPanel organizationId={organizationId} connection={details.scoringConnection} onActivated={(connection) => setDetails({ ...details, scoringConnection: connection })} />
    </div>
  </>;
}
