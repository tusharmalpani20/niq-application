...
export function UsersPage() {
  ...
  return <><PageHeader eyebrow="Access management" title="Users" description="Invite and manage people who can access Apollo Group." action={<button className="btn btn-primary" onClick={() => setInvite(!invite)}><Icon name="plus" size={18}/>Invite user</button>}/>
